...
১. নিচের "ফোল্ডার নির্বাচন করুন" বাটনে ট্যাপ করুন — পিকার সরাসরি "Download" ফোল্ডারে খুলবে
২. উপরে ডানদিকে "এই ফোল্ডারে ব্যবহার করুন" (Use this folder) বাটনে ট্যাপ করুন
